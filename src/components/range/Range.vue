  ...
  methods: {
    ...
    paint() {
      ...
      obstacleList.forEach(obstacle => {
        ...
        info.corners.forEach((obsCorner, index) => {
          const cornerAngleDiff = this.arrangeAngle(
            this.calcAngle(obsCorner) - centerAngle
          );
        ...
        info.angle.min.angle = this.arrangeAngle(
          centerAngle + info.angle.min.angle
        );
        info.angle.max.angle = this.arrangeAngle(
