<template>
  <spec-frame property="fileUploaderWindow" label-str="ファイルアップローダー" lastVersion="1.0.0b11" :isSpecFixed="true">
    <!----------------------
     ! 起動操作
     !--------------------->
    ...
    <spec-item class-str="spec" label-str="仕様">
      ...
      <li>
        ファイル名に "_"(アンダースコア) が２つ連続で含まれている場合、それ以降の "_" で区切られた部分を「画像に付与した情報」として処理する。<br>
        立ち絵のベース画像が選ばれた際、ファイル名がベース画像のファイル名で始まる画像ファイルを全て探し出し、差分画像として設定する。<br>
        ...
        画像④：other.png<br>
        <br>
        立ち絵設定において、画像①をベース画像に選択した場合、画像②と画像③が差分画像として自動で設定される。<br>
        ※ 画像④は無視される<br>
        画像②のファイル名は "__" が含まれているため、それ以降の "_" で区切られている7つの数値が「画像に付与した情報」として取得できる。<br>
        ...
        反転しなければ(30px, 40px), 反転した場合は(70px, 40px)の位置に、ベース画像に対して重ねる方法で描画されるという意味になる。<br>
