<template>
  <spec-frame property="deleteImageWindow" label-str="画像削除画面" lastVersion="1.0.0b1" :isSpecFixed="true">
    <!----------------------
     ! 起動操作
     !--------------------->
    ...
    <spec-item class-str="spec" label-str="仕様">
      <li>既に参照可能となっている画像を選択して削除する</li>
      <li>既に参照されている画像はマークをつけて表示し、削除対象として選択できないようにする</li>
    </spec-item>
    <!----------------------
     ! ユーザ要望
     !--------------------->
